	...
	try {
		if (isset($_POST['btnUpdate'])) {
			if (empty(trim($_POST['idx_lname'])) || empty(trim($_POST['idx_fname'])) || empty(trim($_POST['idx_mname'])) || empty(trim($_POST['idx_cmpny']))) {
				...
				$itxt_ulevpos = trim($_POST['idx_ulevpos']);
				$levposit = $itxt_ulevpos;
				include_once "../../../inc/acctype/acctype.php";
				$itxt_xposition = $currposit;
	...
	<div class="container-fluid bg-light-opacity">
		<form method="post" class="needs-validation" novalidate>
			...
			<div class="input-group mb-3 input-group-sm">
				...
				<select id="idx_ulevpos" class="form-control" name="idx_ulevpos" required autofocus>
			...
			<div class="input-group mb-3 input-group-sm">
				...
				<input id="idx_mname" name="idx_mname" type="text" class="form-control" placeholder="Middle Name" required value="<?php echo $mname; ?>">
				<div class="valid-feedback">Valid.</div>
				<div class="invalid-feedback">Please fill out this field.</div>
			</div>
