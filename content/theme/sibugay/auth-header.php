...
<head>
	...
	<style>
		.bg-color-custom: <?php echo $fifthcolor; ?>;
	</style>
...
<body id="myAuth" class="<?php echo $loginbgcolor; ?>" data-spy="scroll" data-target=".navbar" data-offset="60" oncontextmenu="return false;">